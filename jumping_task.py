...
class JumpTaskEnv(object):
  ...
  """
  def __init__(self, scr_w=84, scr_h=84, floor_height=20,
...
if __name__ == '__main__':
  ...
  parser.add_argument('--scr_w', type=int, default=84,
                      help='screen width, by default 84 pixels')
  parser.add_argument('--scr_h', type=int, default=84,
                      help='screen height, by default 84 pixels')
  parser.add_argument('--floor_height', type=int, default=20,
                      help='the y position of the floor in pixels, by default 20 pixels')
